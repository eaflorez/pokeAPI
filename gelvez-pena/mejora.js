...
const mostrarPokemonEnTarjeta = (datos) => {
  ...
  imagenResultadoEl.src =
    datos.sprites.other.dream_world.front_default || datos.sprites.front_default; // Imagen de alta calidad, si no existe usa la estándar
...
const buscarPokemon = async () => {
  ...
  try {
    ...
    imagenResultadoEl.src =
      "https://cdn-icons-png.flaticon.com/512/5049/5049102.png"; // Imagen de error
